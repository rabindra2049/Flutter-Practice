...
void main() {
  ...
  testWidgets("ListTile will horzontally scroll if cast list more than 3",
    ...
    final lastListTileFinder =
        find.byKey(ValueKey("101")); // Find the last ListTile widget

    await tester.scrollUntilVisible(lastListTileFinder, 100,
        scrollable: find.byType(Scrollable)); // Scroll to the last ListTile
    await tester.pumpAndSettle(); // Wait for animations to complete

    expect(find.text("Shyam Acharya2"), findsOneWidget);
  });
}
