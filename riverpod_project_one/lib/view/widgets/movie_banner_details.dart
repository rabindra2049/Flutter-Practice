...
class MovieBannerDetails extends StatelessWidget {
  final List<Movie> movies;

  const MovieBannerDetails({Key? key, required this.movies}) : super(key: key);
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                    image: NetworkImage(
                        ConfigFile.imageBaseUrlCover + movie.backdrop_path!),
                    fit: BoxFit.fill),
                boxShadow: [
                  BoxShadow(
                    color: Colors.grey.withOpacity(0.1),
